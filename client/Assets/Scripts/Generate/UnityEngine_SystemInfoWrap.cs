...
public class UnityEngine_SystemInfoWrap
{
	...
	static int SupportsRenderTextureFormat(IntPtr L)
	{
		try
		{
			...
			UnityEngine.RenderTextureFormat arg0 = (UnityEngine.RenderTextureFormat)(int)LuaDLL.lua_tonumber(L, 1);
	...
	static int SupportsTextureFormat(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.TextureFormat arg0 = (UnityEngine.TextureFormat)(int)LuaDLL.lua_tonumber(L, 1);
