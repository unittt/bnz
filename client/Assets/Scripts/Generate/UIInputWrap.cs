...
public class UIInputWrap
{
	public static void Register(LuaState L)
	{
        ...
        L.RegFunction("GetInputLength", GetInputLength);
    ...
    [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
    static int GetInputLength(IntPtr L)
    {
        try
        {
            ToLua.CheckArgsCount(L, 1);
            UIInput obj = (UIInput)ToLua.CheckObject(L, 1, typeof(UIInput));
            ToLua.Push(L, obj.GetInputLength());
            return 1;
        }
        catch (Exception e)
        {
	...
	static int set_inputType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIInput obj = (UIInput)o;
			UIInput.InputType arg0 = (UIInput.InputType)(int)LuaDLL.lua_tonumber(L, 2);
			obj.inputType = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_onReturnKey(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIInput obj = (UIInput)o;
			UIInput.OnReturnKey arg0 = (UIInput.OnReturnKey)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_keyboardType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIInput obj = (UIInput)o;
			UIInput.KeyboardType arg0 = (UIInput.KeyboardType)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_validation(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIInput obj = (UIInput)o;
			UIInput.Validation arg0 = (UIInput.Validation)(int)LuaDLL.lua_tonumber(L, 2);
			obj.validation = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_onValidate(IntPtr L)
	{
        ...
        //    UIEventHandler.Get(obj.gameObject).AddOnValidate(obj, func);
        //    return 0;
        //}
        //catch(Exception e)
        //{
