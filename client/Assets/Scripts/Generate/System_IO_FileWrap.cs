...
public class System_IO_FileWrap
{
	...
	static int Open(IntPtr L)
	{
		try
		{
			...
			{
				string arg0 = ToLua.ToString(L, 1);
				System.IO.FileMode arg1 = (System.IO.FileMode)(int)LuaDLL.lua_tonumber(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(int), typeof(int)))
			{
				string arg0 = ToLua.ToString(L, 1);
				System.IO.FileMode arg1 = (System.IO.FileMode)(int)LuaDLL.lua_tonumber(L, 2);
				System.IO.FileAccess arg2 = (System.IO.FileAccess)(int)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(int), typeof(int), typeof(int)))
			{
				...
				System.IO.FileMode arg1 = (System.IO.FileMode)(int)LuaDLL.lua_tonumber(L, 2);
				System.IO.FileAccess arg2 = (System.IO.FileAccess)(int)LuaDLL.lua_tonumber(L, 3);
				System.IO.FileShare arg3 = (System.IO.FileShare)(int)LuaDLL.lua_tonumber(L, 4);
	...
	static int SetAttributes(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			string arg0 = ToLua.CheckString(L, 1);
			System.IO.FileAttributes arg1 = (System.IO.FileAttributes)(int)LuaDLL.lua_tonumber(L, 2);
