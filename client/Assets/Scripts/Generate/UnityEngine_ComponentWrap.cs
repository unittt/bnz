...
public class UnityEngine_ComponentWrap
{
	...
	static int SendMessageUpwards(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Component), typeof(string), typeof(int)))
			{
				UnityEngine.Component obj = (UnityEngine.Component)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Component), typeof(string), typeof(object), typeof(int)))
			{
				UnityEngine.Component obj = (UnityEngine.Component)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				object arg1 = ToLua.ToVarObject(L, 3);
