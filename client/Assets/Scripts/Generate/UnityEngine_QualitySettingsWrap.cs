...
public class UnityEngine_QualitySettingsWrap
{
	...
	static int set_shadowProjection(IntPtr L)
	{
		try
		{
			UnityEngine.ShadowProjection arg0 = (UnityEngine.ShadowProjection)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_shadowResolution(IntPtr L)
	{
		try
		{
			UnityEngine.ShadowResolution arg0 = (UnityEngine.ShadowResolution)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_blendWeights(IntPtr L)
	{
		try
		{
			UnityEngine.BlendWeights arg0 = (UnityEngine.BlendWeights)(int)LuaDLL.lua_tonumber(L, 2);
