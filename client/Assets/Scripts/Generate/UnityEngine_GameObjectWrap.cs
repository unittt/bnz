...
public class UnityEngine_GameObjectWrap
{
	public static void Register(LuaState L)
	{
        ...
        L.RegFunction("GetMissingComponent", GetMissingComponent);
	...
	static int CreatePrimitive(IntPtr L)
	{
		try
		{
			...
			UnityEngine.PrimitiveType arg0 = (UnityEngine.PrimitiveType)(int)LuaDLL.lua_tonumber(L, 1);
	...
	static int SendMessageUpwards(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GameObject), typeof(string), typeof(int)))
			{
				UnityEngine.GameObject obj = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				UnityEngine.SendMessageOptions arg1 = (UnityEngine.SendMessageOptions)(int)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GameObject), typeof(string), typeof(object), typeof(int)))
			{
				UnityEngine.GameObject obj = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				object arg1 = ToLua.ToVarObject(L, 3);
				UnityEngine.SendMessageOptions arg2 = (UnityEngine.SendMessageOptions)(int)LuaDLL.lua_tonumber(L, 4);
