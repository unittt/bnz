...
public class UnityEngine_TextureWrap
{
	public static void Register(LuaState L)
	{
        ...
        L.RegFunction("ConvertToTex2D", ConvertTo_Texture2D);
    ...
    [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
    static int ConvertTo_Texture2D(IntPtr L)
    {
        try
        {
            ToLua.CheckArgsCount(L, 1);
            UnityEngine.Texture obj = (UnityEngine.Texture)ToLua.CheckObject(L, 1, typeof(UnityEngine.Texture));
            UnityEngine.Texture2D tex2dObj = (UnityEngine.Texture2D)obj;
            ToLua.Push(L, tex2dObj);
            return 1;            
        }
        catch (Exception e)
        {
	...
	static int set_anisotropicFiltering(IntPtr L)
	{
		try
		{
			UnityEngine.AnisotropicFiltering arg0 = (UnityEngine.AnisotropicFiltering)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_filterMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Texture obj = (UnityEngine.Texture)o;
			UnityEngine.FilterMode arg0 = (UnityEngine.FilterMode)(int)LuaDLL.lua_tonumber(L, 2);
			obj.filterMode = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_wrapMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Texture obj = (UnityEngine.Texture)o;
			UnityEngine.TextureWrapMode arg0 = (UnityEngine.TextureWrapMode)(int)LuaDLL.lua_tonumber(L, 2);
			obj.wrapMode = arg0;
			return 0;
		}
		catch(Exception e)
