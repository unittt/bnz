...
public class UILabelWrap
{
	...
	static int GetCharacterIndex(IntPtr L)
	{
		try
		{
			...
			UILabel obj = (UILabel)ToLua.CheckObject(L, 1, typeof(UILabel));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
			UnityEngine.KeyCode arg1 = (UnityEngine.KeyCode)(int)LuaDLL.lua_tonumber(L, 3);
	...
	static int set_keepCrispWhenShrunk(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UILabel obj = (UILabel)o;
			UILabel.Crispness arg0 = (UILabel.Crispness)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_overflowMethod(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UILabel obj = (UILabel)o;
			UILabel.Overflow arg0 = (UILabel.Overflow)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_modifier(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UILabel obj = (UILabel)o;
			UILabel.Modifier arg0 = (UILabel.Modifier)(int)LuaDLL.lua_tonumber(L, 2);
			obj.modifier = arg0;
			return 0;
		}
		catch(Exception e)
