...
public class UIPanelWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("uiEffectDrawCallCount", get_uiEffectDrawCallCount, set_uiEffectDrawCallCount);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_uiEffectDrawCallCount(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			int ret = obj.uiEffectDrawCallCount;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index uiEffectDrawCallCount on a nil value" : e.Message);
		}
	}
	...
	static int set_renderQueue(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			UIPanel.RenderQueue arg0 = (UIPanel.RenderQueue)(int)LuaDLL.lua_tonumber(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_uiEffectDrawCallCount(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			UIPanel obj = (UIPanel)o;
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
			obj.uiEffectDrawCallCount = arg0;
			return 0;
		}
		catch(Exception e)
		{
	...
	static int set_onClipMove(IntPtr L)
	{
        ...
        //    UIPanel obj = (UIPanel)o;
        //    LuaFunction func = ToLua.ToLuaFunction(L, 2);
        //    UIEventHandler.Get(obj.gameObject).AddOnClipMove(obj, func);
        //    return 0;
        //}
        //catch(Exception e)
        //{
	...
	static int set_clipping(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			UIDrawCall.Clipping arg0 = (UIDrawCall.Clipping)(int)LuaDLL.lua_tonumber(L, 2);
			obj.clipping = arg0;
			return 0;
		}
		catch(Exception e)
