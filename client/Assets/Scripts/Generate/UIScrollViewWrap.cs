...
public class UIScrollViewWrap
{
	...
	static int set_movement(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIScrollView obj = (UIScrollView)o;
			UIScrollView.Movement arg0 = (UIScrollView.Movement)(int)LuaDLL.lua_tonumber(L, 2);
			obj.movement = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_dragEffect(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIScrollView obj = (UIScrollView)o;
			UIScrollView.DragEffect arg0 = (UIScrollView.DragEffect)(int)LuaDLL.lua_tonumber(L, 2);
			obj.dragEffect = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_showScrollBars(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIScrollView obj = (UIScrollView)o;
			UIScrollView.ShowCondition arg0 = (UIScrollView.ShowCondition)(int)LuaDLL.lua_tonumber(L, 2);
