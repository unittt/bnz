...
public class UITableWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("calcSingle", get_calcSingle, set_calcSingle);
	...
	static int GetChildList(IntPtr L)
	{
		try
		{
            ...
            {
                UnityEngine.Transform transform = o[i];
                ToLua.Push(L, i + 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_calcSingle(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UITable obj = (UITable)o;
			bool ret = obj.calcSingle;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index calcSingle on a nil value" : e.Message);
		}
	}
	...
	static int set_direction(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UITable obj = (UITable)o;
			UITable.Direction arg0 = (UITable.Direction)(int)LuaDLL.lua_tonumber(L, 2);
			obj.direction = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_sorting(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UITable obj = (UITable)o;
			UITable.Sorting arg0 = (UITable.Sorting)(int)LuaDLL.lua_tonumber(L, 2);
			obj.sorting = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_pivot(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UITable obj = (UITable)o;
			UIWidget.Pivot arg0 = (UIWidget.Pivot)(int)LuaDLL.lua_tonumber(L, 2);
			obj.pivot = arg0;
			return 0;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_calcSingle(IntPtr L)
	{
		object o = null;
