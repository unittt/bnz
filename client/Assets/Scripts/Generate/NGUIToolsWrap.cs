...
public class NGUIToolsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetSubPanelDepthDeep", SetSubPanelDepthDeep);
		L.RegFunction("SetSubWidgetDepthDeep", SetSubWidgetDepthDeep);
	...
	static int KeyToCaption(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.KeyCode arg0 = (UnityEngine.KeyCode)(int)LuaDLL.lua_tonumber(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetSubPanelDepthDeep(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 1, typeof(UnityEngine.GameObject));
			NGUITools.SetSubPanelDepthDeep(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetSubWidgetDepthDeep(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 1, typeof(UnityEngine.GameObject));
			NGUITools.SetSubWidgetDepthDeep(arg0);
			return 0;
		}
		catch (Exception e)
		{
