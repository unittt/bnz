...
public class UnityEngine_AnimationWrap
{
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Animation), typeof(int)))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				UnityEngine.PlayMode arg0 = (UnityEngine.PlayMode)(int)LuaDLL.lua_tonumber(L, 2);
				bool o = obj.Play(arg0);
				LuaDLL.lua_pushboolean(L, o);
				return 1;
			}
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Animation), typeof(string), typeof(int)))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				UnityEngine.PlayMode arg1 = (UnityEngine.PlayMode)(int)LuaDLL.lua_tonumber(L, 3);
	...
	static int CrossFade(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Animation), typeof(string), typeof(float), typeof(int)))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
				UnityEngine.PlayMode arg2 = (UnityEngine.PlayMode)(int)LuaDLL.lua_tonumber(L, 4);
	...
	static int CrossFadeQueued(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Animation), typeof(string), typeof(float), typeof(int)))
			{
				...
				string arg0 = ToLua.ToString(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
				UnityEngine.QueueMode arg2 = (UnityEngine.QueueMode)(int)LuaDLL.lua_tonumber(L, 4);
				UnityEngine.AnimationState o = obj.CrossFadeQueued(arg0, arg1, arg2);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Animation), typeof(string), typeof(float), typeof(int), typeof(int)))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
				UnityEngine.QueueMode arg2 = (UnityEngine.QueueMode)(int)LuaDLL.lua_tonumber(L, 4);
				UnityEngine.PlayMode arg3 = (UnityEngine.PlayMode)(int)LuaDLL.lua_tonumber(L, 5);
	...
	static int PlayQueued(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Animation), typeof(string), typeof(int)))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				UnityEngine.QueueMode arg1 = (UnityEngine.QueueMode)(int)LuaDLL.lua_tonumber(L, 3);
				UnityEngine.AnimationState o = obj.PlayQueued(arg0, arg1);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Animation), typeof(string), typeof(int), typeof(int)))
			{
				UnityEngine.Animation obj = (UnityEngine.Animation)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				UnityEngine.QueueMode arg1 = (UnityEngine.QueueMode)(int)LuaDLL.lua_tonumber(L, 3);
	...
	static int set_cullingType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Animation obj = (UnityEngine.Animation)o;
			UnityEngine.AnimationCullingType arg0 = (UnityEngine.AnimationCullingType)(int)LuaDLL.lua_tonumber(L, 2);
