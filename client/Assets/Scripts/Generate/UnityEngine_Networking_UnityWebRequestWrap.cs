...
public class UnityEngine_Networking_UnityWebRequestWrap
{
	...
	static int _CreateUnityEngine_Networking_UnityWebRequest(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(string), typeof(UnityEngine.Networking.DownloadHandler), typeof(UnityEngine.Networking.UploadHandler)))
			{
				string arg0 = ToLua.CheckString(L, 1);
				string arg1 = ToLua.CheckString(L, 2);
				UnityEngine.Networking.DownloadHandler arg2 = (UnityEngine.Networking.DownloadHandler)ToLua.CheckObject(L, 3, typeof(UnityEngine.Networking.DownloadHandler));
				UnityEngine.Networking.UploadHandler arg3 = (UnityEngine.Networking.UploadHandler)ToLua.CheckObject(L, 4, typeof(UnityEngine.Networking.UploadHandler));
	...
	static int GetAudioClip(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			UnityEngine.AudioType arg1 = (UnityEngine.AudioType)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int GetAssetBundle(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(uint), typeof(uint)))
			{
				string arg0 = ToLua.ToString(L, 1);
				uint arg1 = (uint)LuaDLL.lua_tonumber(L, 2);
				uint arg2 = (uint)LuaDLL.lua_tonumber(L, 3);
	...
	static int Post(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>)))
			{
				string arg0 = ToLua.ToString(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>), typeof(byte[])))
			{
				string arg0 = ToLua.ToString(L, 1);
				System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection> arg1 = (System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>)ToLua.ToObject(L, 2);
	...
	static int get_disposeDownloadHandlerOnDispose(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index disposeDownloadHandlerOnDispose on a nil value" : e.Message);
		}
	}
	...
	static int get_disposeUploadHandlerOnDispose(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index disposeUploadHandlerOnDispose on a nil value" : e.Message);
		}
	}
	...
	static int get_useHttpContinue(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index useHttpContinue on a nil value" : e.Message);
		}
	}
	...
	static int get_responseCode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index responseCode on a nil value" : e.Message);
		}
	}
	...
	static int get_isModifiable(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isModifiable on a nil value" : e.Message);
		}
	}
	...
	static int get_isError(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isError on a nil value" : e.Message);
		}
	}
	...
	static int get_downloadProgress(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index downloadProgress on a nil value" : e.Message);
		}
	}
	...
	static int get_uploadedBytes(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index uploadedBytes on a nil value" : e.Message);
		}
	}
	...
	static int get_downloadedBytes(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index downloadedBytes on a nil value" : e.Message);
		}
	}
	...
	static int get_redirectLimit(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index redirectLimit on a nil value" : e.Message);
		}
	}
	...
	static int get_chunkedTransfer(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index chunkedTransfer on a nil value" : e.Message);
		}
	}
	...
	static int get_uploadHandler(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index uploadHandler on a nil value" : e.Message);
		}
	}
	...
	static int get_downloadHandler(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index downloadHandler on a nil value" : e.Message);
		}
	}
	...
	static int set_uploadHandler(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Networking.UnityWebRequest obj = (UnityEngine.Networking.UnityWebRequest)o;
			UnityEngine.Networking.UploadHandler arg0 = (UnityEngine.Networking.UploadHandler)ToLua.CheckObject(L, 2, typeof(UnityEngine.Networking.UploadHandler));
	...
	static int set_downloadHandler(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Networking.UnityWebRequest obj = (UnityEngine.Networking.UnityWebRequest)o;
			UnityEngine.Networking.DownloadHandler arg0 = (UnityEngine.Networking.DownloadHandler)ToLua.CheckObject(L, 2, typeof(UnityEngine.Networking.DownloadHandler));
