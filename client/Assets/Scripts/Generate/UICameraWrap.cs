...
public class UICameraWrap
{
	...
	static int set_eventType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UICamera obj = (UICamera)o;
			UICamera.EventType arg0 = (UICamera.EventType)(int)LuaDLL.lua_tonumber(L, 2);
			obj.eventType = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_processEventsIn(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UICamera obj = (UICamera)o;
			UICamera.ProcessEventsIn arg0 = (UICamera.ProcessEventsIn)(int)LuaDLL.lua_tonumber(L, 2);
	...
	static int set_submitKey0(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UICamera obj = (UICamera)o;
			UnityEngine.KeyCode arg0 = (UnityEngine.KeyCode)(int)LuaDLL.lua_tonumber(L, 2);
			obj.submitKey0 = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_currentScheme(IntPtr L)
	{
		try
		{
			UICamera.ControlScheme arg0 = (UICamera.ControlScheme)(int)LuaDLL.lua_tonumber(L, 2);
