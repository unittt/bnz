	...
	cmds={
		...
		[3]={
			args={
				...
				calc_face=true,
				ease_type=[[Linear]],
				end_relative={base_pos=[[atk]],depth=0,relative_angle=0,relative_dis=3.85,},
		...
		[5]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_206_hit/Prefabs/Skill_eff_206_hit.prefab]],
					preload=false,
				},
		...
		[6]={
			args={shake_dis=2,shake_rate=2,shake_time=0.15,},
