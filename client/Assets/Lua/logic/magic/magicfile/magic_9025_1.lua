...
DATA={
	...
	cmds={
		...
		[3]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_185_full/Prefabs/Skill_eff_185_full.prefab]],
					preload=false,
				},
		...
		[4]={
			args={sound_path={soundpath=[[Audio/Sound/War/laohu2.ogg]],},},
			func_name=[[PlaySound]],
			start_time=0.8,
		},
		[5]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_185_full/Prefabs/Skill_eff_185_hit.prefab]],
					preload=false,
				},
