...
DATA={
	...
	cmds={
		...
		[2]={
			args={
				alive_time=0.5,
				begin_pos={base_pos=[[atk]],depth=1.4,relative_angle=0,relative_dis=0,},
				delay_time=0,
				ease_type=[[Linear]],
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/skill_eff_5139_attack1_fly/Prefabs/skill_eff_5139_attack1_fly.prefab]],
					preload=false,
				},
