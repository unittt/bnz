		...
		[6]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_194_hit/Prefabs/Skill_eff_194_hit.prefab]],
					preload=false,
				},
		...
		[8]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_194_hit/Prefabs/Skill_eff_194_fly_1.prefab]],
				},
		...
		[9]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_194_hit/Prefabs/Skill_eff_194_fly_2.prefab]],
				},
				end_pos={base_pos=[[atk_lineup]],depth=0.7,relative_angle=0,relative_dis=0,},
				excutor=[[vicobj]],
				move_time=0.8,
		...
		[13]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_194_hit/Prefabs/Skill_eff_194_body.prefab]],
					preload=false,
				},
