...
DATA={
	...
	cmds={
		...
		[4]={
			args={sound_path={soundpath=[[Audio/Sound/War/yqgy.ogg]],},},
			func_name=[[PlaySound]],
			start_time=0.7,
		},
		[5]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_175_full/Prefabs/Skill_eff_175_full.prefab]],
					preload=false,
				},
		...
		[6]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/Skill_eff_173_hit/Prefabs/Skill_eff_173_hit.prefab]],
					preload=false,
				},
				effect_dir_type=[[forward]],
