...
function CEditorAnimView.RedefineFunc(self)
	...
	CMagicCtrl.GetFileData = function (a1,a2,a3)
		...
		printc("self.m_SequenceBox.m_TotalFrame: " .. self.m_SequenceBox.m_TotalFrame)
...
function CEditorAnimView.InitContent(self)
	...
	self.m_SaveData = table.copy(datauser.comboactdata.DATA)
...
function CEditorAnimView.SaveToFile(self)
	...
	local path = IOTools.GetAssetPath("/Lua/logic/datauser/comboactdata.lua")
