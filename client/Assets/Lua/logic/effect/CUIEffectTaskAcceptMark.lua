local CUIEffectTaskAcceptMark = class("CUIEffectTaskAcceptMark", CObject)

function CUIEffectTaskAcceptMark.ctor(self, oAttach, size, pos)
	...
	g_ResCtrl:LoadCloneAsync("Effect/UI/ui_eff_0023/Prefabs/ui_eff_0023.prefab", callback(self, "OnEffLoad"), false)
end 

function CUIEffectTaskAcceptMark.OnEffLoad(self, oClone, sPath)
...
function CUIEffectTaskAcceptMark.RecaluatePanelDepth(self)
	if self.m_Eff then
		self.m_Eff.m_RenderQComponent:RecaluatePanelDepth()
	end
end

return CUIEffectTaskAcceptMark