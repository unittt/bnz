local CUIEffectWenShiAttr = class("CUIEffectWenShiAttr", CWidget)

function CUIEffectWenShiAttr.ctor(self, oAttach, cb, pos)
    ...
    self.m_EffPos = pos
    g_ResCtrl:LoadCloneAsync("Effect/UI/ui_eff_0097/Prefabs/ui_eff_0097.prefab", callback(self, "OnEffLoad"), false)
end

function CUIEffectWenShiAttr.OnEffLoad(self, oClone)
