local CUIEffectWenShiFusion = class("CUIEffectWenShiFusion", CWidget)

function CUIEffectWenShiFusion.ctor(self, oAttach, cb, pos)
    ...
    self.m_EffPos = pos
    g_ResCtrl:LoadCloneAsync("Effect/UI/ui_eff_0096/Prefabs/ui_eff_0096.prefab", callback(self, "OnEffLoad"), false)
end

function CUIEffectWenShiFusion.OnEffLoad(self, oClone)
