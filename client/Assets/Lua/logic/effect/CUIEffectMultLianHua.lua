local CUIEffectMultLianHua = class("CUIEffectMultLianHua", CWidget)

function CUIEffectMultLianHua.ctor(self, oAttach, cb, pos)
    ...
    self.m_EffPos = pos
    g_ResCtrl:LoadCloneAsync("Effect/UI/ui_eff_0089/Prefabs/ui_eff_0089.prefab", callback(self, "OnEffLoad"), false)
end

function CUIEffectMultLianHua.OnEffLoad(self, oClone)
