local CUIEffectGhostEye = class("CUIEffectGhostEye", CObject)

function CUIEffectGhostEye.ctor(self, oAttach, size, pos, rotate)
	...
	g_ResCtrl:LoadCloneAsync("Effect/UI/ui_eff_0016/Prefabs/ui_eff_0016.prefab", callback(self, "OnEffLoad"), false)
end 

function CUIEffectGhostEye.OnEffLoad(self, oClone, sPath)
...
function CUIEffectGhostEye.RecaluatePanelDepth(self)
	if self.m_Eff then
		self.m_Eff.m_RenderQComponent:RecaluatePanelDepth()
	end
end

return CUIEffectGhostEye