local CUIEffectTreasureGoldPrize = class("CUIEffectTreasureGoldPrize", CWidget)

function CUIEffectTreasureGoldPrize.ctor(self, oAttach)
	...
	g_ResCtrl:LoadCloneAsync("Effect/UI/ui_eff_0019/Prefabs/ui_eff_0019.prefab", callback(self, "OnEffLoad"), false)
end


function CUIEffectTreasureGoldPrize.OnEffLoad(self, oClone, errcode)
...
function CUIEffectTreasureGoldPrize.RecaluatePanelDepth(self)
	if self.m_Eff then
...
return CUIEffectTreasureGoldPrize