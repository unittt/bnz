...
public class IOSNotificationController : ISN_Singleton<IOSNotificationController> {
	...
	#if IOSNATIVE_ENABLED && (UNITY_IPHONE && !UNITY_EDITOR && PUSH_ENABLED && PUSH_ENABLED) || SA_DEBUG_MODE
	void FixedUpdate() {
	...
	public void RegisterForRemoteNotifications(NotificationType notificationTypes) {;
		...
		#if IOSNATIVE_ENABLED && (UNITY_IPHONE && !UNITY_EDITOR && PUSH_ENABLED) || SA_DEBUG_MODE
