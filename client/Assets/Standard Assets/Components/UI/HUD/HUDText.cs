...
public class HUDText : MonoBehaviour
{
    ...
    Entry Create()
    {
        ...
        ne.label.gradientTop = _lblTopColor;
        ne.label.gradientBottom = _lblBottomColor;
        ne.label.applyGradient = _gradientState;
    ...
    private Color _lblTopColor = Color.white;
    private Color _lblBottomColor = Color.white;
    private bool _gradientState = true;
    public void Add(object obj, Color c, float stayDuration, bool gradientState, Color gradientTopColor, Color gradientBottomColor)
    {
        _lblTopColor = gradientTopColor;
        _lblBottomColor = gradientBottomColor;
        _gradientState = gradientState;
        Add(obj, c, stayDuration, false);
    }

    void ResetLblColor()
    {
        _lblTopColor = Color.white;
        _lblBottomColor = Color.white;
    }
    ...
    public void Add(object obj, Color c, float stayDuration, bool clearlblColor = true)
    {
        if (!enabled) return;
