...
static public class NGUIMath
{
	...
	static public Bounds CalculateRelativeWidgetBoundsExt (Transform trans, bool considerInactive, int calcSingle) {
		return CalculateRelativeWidgetBounds(trans, trans, considerInactive, true, calcSingle);
	}
	...
	static public Bounds CalculateRelativeWidgetBounds (Transform relativeTo, Transform content, bool considerInactive, bool considerChildren = true, int calcSingle = 0)
	{
		if (content != null && relativeTo != null)
		{
			...
			CalculateRelativeWidgetBounds(content, considerInactive, true, ref toLocal, ref min, ref max, ref isSet, considerChildren, calcSingle);
	...
	static void CalculateRelativeWidgetBounds (Transform content, bool considerInactive, bool isRoot,
		ref Matrix4x4 toLocal, ref Vector3 vMin, ref Vector3 vMax, ref bool isSet, bool considerChildren, int calcSingle = 0)
	{
