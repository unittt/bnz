...
{
    //UIGeometry重用
    public static Stack<UIGeometry> cacheUIGeometry = new Stack<UIGeometry>(512);
    ...
    public static UIGeometry Get()
    {
        if(cacheUIGeometry.Count > 0)
        {
            return cacheUIGeometry.Pop();
        }
        else
        {
    ...
    public static void Recycle(UIGeometry obj)
    {
        cacheUIGeometry.Push(obj);
    }
}
