...
public class UIToggle : UIWidgetContainer
{
    ...
    void OnClick() { if (atuoSelect && enabled && isColliderEnabled && UICamera.currentTouchID != -2) value = !value; }
	...
	public void Set (bool state, bool notify = true)
	{
		...
		if (instantTween && activeSprite != null)
		{
			mIsActive = invertSpriteState ? (activeSprite.alpha == 0f) : (activeSprite.alpha == 1f);
		}
		if (mIsActive != state)
		{
