...
public class UITable : UIWidgetContainer
{
	...
	//	获取第一子的Widget作为计算排列宽高
	public bool calcSingle = false;
	...
	public List<Transform> GetChildList ()
	{
        ...
        List<Transform> list = new List<Transform>(myTrans.childCount);
	...
	protected void RepositionVariableSize (List<Transform> children)
	{
		...
		for (int i = 0, imax = children.Count; i < imax; ++i)
		{
			...
			Bounds b = calcSingle? NGUIMath.CalculateRelativeWidgetBoundsExt(t, !hideInactive, 1)
				: NGUIMath.CalculateRelativeWidgetBounds(t, !hideInactive);
