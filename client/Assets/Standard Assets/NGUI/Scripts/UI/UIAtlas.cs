...
public class UIAtlas : MonoBehaviour
{
    ...
    { 
        get 
        { 
            return (mReplacement != null) ? mReplacement.texture : (material != null ? material.mainTexture as Texture : null); 
        } 
    }


    public Texture alphaTextue
    {
        get
        {
            if(mReplacement != null)
            {
                return mReplacement.alphaTextue;
            }
            else
            {
                if(material != null && material.HasProperty("_AlphaTex"))
                {
                    return material.GetTexture("_AlphaTex") as Texture;
                }
                else
                {
                    return null;
