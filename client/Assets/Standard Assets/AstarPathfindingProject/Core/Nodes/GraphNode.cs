...
namespace Pathfinding {
	...
	public abstract class GraphNode {
        ...
        const uint FlagsTagMask = (16 - 1) << FlagsTagOffset;

        const int FlagsTransparentOffset = 23;

        const uint FlagsTransparentMask = 1 << FlagsTransparentOffset;
        ...
        {
            get { return (flags & FlagsTransparentMask) >> FlagsTransparentOffset > 0; }
            set { flags = flags & ~FlagsTransparentMask | (value ? 1u : 0u) << FlagsTransparentOffset; }
        }
